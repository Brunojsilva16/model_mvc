...
class DataHelper
{
    ...
    /**
     * Formata uma data para o padrão brasileiro (d/m/Y) ou outro formato especificado.
     *
     * @param string|null $date Data a ser formatada
     * @param string $format Formato de saída desejado (padrão d/m/Y)
     * @return string
     */
